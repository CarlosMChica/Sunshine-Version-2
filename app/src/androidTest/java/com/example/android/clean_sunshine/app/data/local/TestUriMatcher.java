...
public class TestUriMatcher extends AndroidTestCase {
    ...
    private static final Uri TEST_WEATHER_DIR = ForecastContract.WeatherEntry.CONTENT_URI;
    private static final Uri TEST_WEATHER_WITH_LOCATION_DIR = ForecastContract.WeatherEntry.buildWeatherLocation(LOCATION_QUERY);
    private static final Uri TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR = ForecastContract.WeatherEntry.buildWeatherLocationWithDate(LOCATION_QUERY, TEST_DATE);
    ...
    public void testUriMatcher() {
        ...
        assertEquals("Error: The WEATHER WITH LOCATION AND DATE URI was matched incorrectly.",
                testMatcher.match(TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR), ForecastProvider.WEATHER_WITH_LOCATION_AND_DATE);

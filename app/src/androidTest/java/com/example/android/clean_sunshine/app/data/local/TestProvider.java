...
public class TestProvider extends AndroidTestCase {
    ...
    public void testProviderRegistry() {
        ...
        ComponentName componentName = new ComponentName(mContext.getPackageName(),
                ForecastProvider.class.getName());
        try {
            ...
            assertEquals("Error: WeatherProvider registered with authority: " + providerInfo.authority +
                    " instead of authority: " + ForecastContract.CONTENT_AUTHORITY,
                    providerInfo.authority, ForecastContract.CONTENT_AUTHORITY);
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate+= millisecondsInADay ) {
            ...
            weatherValues.put(ForecastContract.WeatherEntry.COLUMN_DATE, currentTestDate);
            weatherValues.put(ForecastContract.WeatherEntry.COLUMN_DEGREES, 1.1);
            weatherValues.put(ForecastContract.WeatherEntry.COLUMN_HUMIDITY, 1.2 + 0.01 * (float) i);
            weatherValues.put(ForecastContract.WeatherEntry.COLUMN_PRESSURE, 1.3 - 0.01 * (float) i);
            weatherValues.put(ForecastContract.WeatherEntry.COLUMN_MAX_TEMP, 75 + i);
            weatherValues.put(ForecastContract.WeatherEntry.COLUMN_MIN_TEMP, 65 - i);
            weatherValues.put(ForecastContract.WeatherEntry.COLUMN_SHORT_DESC, "Asteroids");
            weatherValues.put(ForecastContract.WeatherEntry.COLUMN_WIND_SPEED, 5.5 + 0.2 * (float) i);

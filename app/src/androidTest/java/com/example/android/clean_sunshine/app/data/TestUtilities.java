...
public class TestUtilities extends AndroidTestCase {
    ...
    static ContentValues createNorthPoleLocationValues() {
        ...
        testValues.put(ForecastContract.LocationEntry.COLUMN_CITY_NAME, "North Pole");
        testValues.put(ForecastContract.LocationEntry.COLUMN_COORD_LAT, 64.7488);
        testValues.put(ForecastContract.LocationEntry.COLUMN_COORD_LONG, -147.353);

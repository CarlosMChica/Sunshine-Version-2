...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        tableNameHashSet.add(ForecastContract.WeatherEntry.TABLE_NAME);
        ...
        locationColumnHashSet.add(ForecastContract.LocationEntry.COLUMN_CITY_NAME);
        locationColumnHashSet.add(ForecastContract.LocationEntry.COLUMN_COORD_LAT);
        locationColumnHashSet.add(ForecastContract.LocationEntry.COLUMN_COORD_LONG);
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        long weatherRowId = db.insert(ForecastContract.WeatherEntry.TABLE_NAME, null, weatherValues);
        assertTrue(weatherRowId != -1);

        // Fourth Step: Query the database and receive a Cursor back
        // A cursor is your primary interface to the query results.
        Cursor weatherCursor = db.query(
                ForecastContract.WeatherEntry.TABLE_NAME,  // Table to Query
    ...
    public long insertLocation() {
        ...
        Cursor cursor = db.query(
                ForecastContract.LocationEntry.TABLE_NAME,  // Table to Query
                null, // all columns

...
public class DbForecastMapper {
  ...
  public ContentValues mapLocationToDb(Location location) {
    ...
    locationValues.put(ForecastContract.LocationEntry.COLUMN_LOCATION_SETTING, location.getLocationSetting());
  ...
  private Location mapLocationFromDb(Cursor cursor) {
    ...
    String locationSetting = cursor.getString(cursor.getColumnIndex(

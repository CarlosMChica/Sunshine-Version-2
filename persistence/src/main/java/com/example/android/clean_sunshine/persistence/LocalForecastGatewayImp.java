...
import static com.example.android.clean_sunshine.persistence.ForecastContract.WeatherEntry.COLUMN_DATE;
import static com.example.android.clean_sunshine.persistence.ForecastContract.WeatherEntry.CONTENT_URI;
import static com.example.android.clean_sunshine.persistence.ForecastContract.WeatherEntry.buildWeatherLocation;
import static com.example.android.clean_sunshine.persistence.ForecastContract.WeatherEntry.buildWeatherLocationWithDate;
...
public class LocalForecastGatewayImp implements LocalForecastGateway {
  ...
  public LocalForecastGatewayImp(Context context, String preferredLocation) {
